...
function ChatInterface() {
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden">
      ...
      <div className=" absolute inset-x-0 bottom-0 mx-auto w-full max-w-3xl shrink-0 px-3  md:px-5">
        <div className="bg-gray-200/50 dark:bg-background/50 rounded-t-3xl p-2 backdrop-blur-sm">
          <FileUpload
